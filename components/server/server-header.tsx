            ...
            <DropdownMenu>
                ...
                >
                    {isModerator && (
                        ...
                        >
                            Invite People
                            <UserPlus className=" h-4 w4 ml-auto"/>
                        </DropdownMenuItem>
                    )}
                    {isAdmin && (
                        <DropdownMenuItem
                        ...
                        >
                            Server Setting
                            <Settings className=" h-4 w4 ml-auto"/>
                        </DropdownMenuItem>
                    )}
                    {isAdmin && (
                        <DropdownMenuItem
                        ...
                        >
                            Manage Members
                            <Users className=" h-4 w4 ml-auto"/>
                        </DropdownMenuItem>
                    )}
                    {isModerator && (
                        <DropdownMenuItem
                        ...
                        >
                            Create Channel
                            <PlusCircle className=" h-4 w4 ml-auto"/>
                        </DropdownMenuItem>
                    )}
                    {
                        isModerator && (
                    ...
                    {isAdmin && (
                        ...
                        >
                            Delete Server
                            <Trash className=" h-4 w4 ml-auto"/>
                        </DropdownMenuItem>
                    )}
                    {!isAdmin && (
                        <DropdownMenuItem
                        ...
                        >
                            Leave Server
                            <LogOut className=" h-4 w4 ml-auto"/>
                        </DropdownMenuItem>
                    )}
                </DropdownMenuContent>
            </DropdownMenu>
